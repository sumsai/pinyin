...
class Pinyin
{
     ...
     * Dict loader.
     *
     * @var \extend\pinyin\DictLoaderInterface
     */
    protected $loader;
    ...
    {
        $this->loader = $loaderName ?: 'extend\\pinyin\\FileDictLoader';
    }
     ...
     * Loader setter.
     *
     * @param \extend\pinyin\DictLoaderInterface $loader
     *
     * @return $this
     */
     ...
     * Return dict loader,.
     *
     * @return \extend\pinyin\DictLoaderInterface
     */
     ...
     *
     * @param string                               $string
     * @param \extend\pinyin\DictLoaderInterface $dictLoader
     *
     * @return string
     */
